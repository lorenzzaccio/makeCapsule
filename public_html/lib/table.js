 ...
 */
            ...
            function searchInArray(col,regex,arr){
                var j;
                var val;
                var counter=0;
            ...
            function seekLineInArray(col,regex,arr){
                var j;
                var val;
                var returnVal=0;
                var rowCount = arr.length;
            ...
            /*
            function seekLineInArray(start_index,col,regex,arr){
                var j;
                var val;
                var returnVal=0;
                var rowCount = arr.length;
                for(j=start_index;j<rowCount;j++){
                    if(arr[j]!=undefined){
                        var arrow = arr[j];
                        val = arrow[col];
                        if(regex==val)
